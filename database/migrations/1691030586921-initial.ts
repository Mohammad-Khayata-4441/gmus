...
export class Initial1691030586921 implements MigrationInterface {
    name = 'Initial1691030586921'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`device\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`isActive\` tinyint NOT NULL, \`inverterId\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
